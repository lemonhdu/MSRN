...
if __name__ == '__main__': 
	...
	parser.add_argument('--datasetpath', type=str, default="/disks/disk0/huangxvfeng/dataset/AQA/videos/")
	parser.add_argument('--outputpath', type=str, default="/disks/disk0/huangxvfeng/dataset/AQA/output_npy")
